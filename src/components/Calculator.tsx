  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg">
      <CardContent className="p-4">
        <div className="mb-4 p-4 bg-white border rounded-md text-right text-3xl font-mono h-16 flex items-center justify-end overflow-hidden">
          {display}
        </div>
        <div className="grid grid-cols-4 gap-2">
          ...
          <Button variant="default" onClick={handleEquals} className="bg-blue-500 text-white hover:bg-blue-600">
            =
          </Button>
        </div>
      </CardContent>
